...
struct Activations{
  ...
  float** queries_reshaped;         // [num_layers][batch_size, num_heads, seq_len, head_dim]
  float** keys_reshaped;            // [num_layers][batch_size, num_heads, seq_len, head_dim]
  float** values_reshaped;          // [num_layers][batch_size, num_heads, seq_len, head_dim]
